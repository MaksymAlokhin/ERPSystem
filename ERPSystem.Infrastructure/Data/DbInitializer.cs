...
namespace ERPSystem.Infrastructure.Data
{
    public static class DbInitializer
    {
        ...
        serviceProvider.GetRequiredService<DbContextOptions<ApplicationDbContext>>()))
            {
                var adminID = await EnsureUser(serviceProvider, testUserPw, "admin@company.com");
                await EnsureClaim(serviceProvider, adminID, "Admin", ""); //Claim based authorization

                var employeeID = await EnsureUser(serviceProvider, testUserPw, "employee@company.com");
